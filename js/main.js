...
const ITEM_AVAILABILITY = {
  'hokkaido-crepe': { label: "Hokkaido Mille Cr\u00e9pe", type: 'list', subtext: 'This Chef\'s Special is part of the current U.S. rotation, available at all {n} JINYA U.S. locations:', locations: [
      ...
      "Topanga Westfield (Canoga Park), CA",
      "Totowa, NJ",
      "TrailHead (Peoria), AZ",
      "Tulsa (Downtown), OK",
      "Union Market (DC), DC",
  ...
  'birria-ramen': { label: 'Birria Ramen', type: 'list', subtext: 'This item is on the U.S. ramen menu, available at all {n} JINYA U.S. locations:', locations: [
      "2nd & PCH (Long Beach), CA",
      "Ally Charlotte Center (Charlotte), NC",
      "Alpharetta, GA",
      "Ameristar Black Hawk, CO",
  ...
  'potato-mochi': { label: 'Potato Mochi Balls', type: 'list', subtext: 'This Chef\'s Special is part of the current Canada rotation, available at all {n} JINYA Canada locations:', locations: [
      "Burnaby (Amazing Brentwood), BC",
      "Calgary, AB",
      "Edmonton, AB",
      "Langley, BC",
      "Macleod (Calgary), AB",
...
(function () {
  ...
  function openLocModal(item, trigger) {
    ...
    if (item.type === 'region') {
      ...
      sub.textContent = item.subtext ? item.subtext.replace('{n}', item.locations.length) : `Confirmed on the menu at ${item.locations.length} JINYA locations:`;
